module.exports = {
    convertUint8ToString: (payload) => {
        if (payload.operationEventSource && payload.operationEventSource !== null) {
        ...
        if (payload.operationEventCode && payload.operationEventCode !== null) {
        ...
        if (payload.programmingEventSource && payload.programmingEventSource !== null) {
        ...
        if (payload.programmingEventCode && payload.programmingEventCode !== null) {
